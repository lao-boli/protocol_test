package org.hqu.lly.protocol.mqtt.client;
            ...
            bootstrap.group(eventLoopGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel ch) throws Exception {
                            ...
                            ch.pipeline().addLast("TCPClientMessageHandler", new MQTTClientMessageHandler(clientService));
                            ch.pipeline().addLast("TCPClientExceptionHandler", new MQTTClientExceptionHandler());
                        }
                    });
